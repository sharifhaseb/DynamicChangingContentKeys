...
def Selim():
    for i in xrange(0,10):
        os.system('fbi -T 10 ./Content/v%s/samplescreen0.png --autozoom --noverbose' % i)
        os.system('fbi -T 11 ./Content/v%s/samplescreen1.png --autozoom --noverbose' % i)
        os.system('fbi -T 12 ./Content/v%s/samplescreen2.png --autozoom --noverbose' % i)
        os.system('fbi -T 13 ./Content/v%s/samplescreen3.png --autozoom --noverbose' % i)
        os.system('fbi -T 14 ./Content/v%s/samplescreen4.png --autozoom --noverbose' % i)
        os.system('fbi -T 15 ./Content/v%s/samplescreen5.png --autozoom --noverbose' % i)
